...
function Notify(TT,DD,WW,CT)
    Fluent:Notify({
        Title = TT,
        Content = DD,
        SubContent = "Script By LightReal", -- Optional
...
function TP(Pos)
    ...
    Info:AddParagraph({
        ...
        Content = "https://discord.gg/Light Hub Community"
    })
    Info:AddButton({
        Title = "Copy Link Discord",
        Description = "https://discord.gg/Light Hub Community",
        Callback = function()
            nGU:Dialog({Title = "Light Hub: Complete Copy [Discord Link]",Content = "Join Discord To Get Notifications About Latest Scripts",
            Buttons = {
                    {
                        Title = "Ok",
                        Callback = function()
    ...
    Info:AddParagraph({
        Title = "Developer LightReal.21",
        Content = "https://discord.gg/Z4BXxMyX"
    })
...
Raid:AddParagraph({
    Title = "Raid",
    Content = "Auto Raid No UnStore Fruit Buy Chip"
})
Raidslist = {}
...
spawn(function()
    ...
    DevilFruit:AddParagraph({ 
        ...
        Misc:AddButton({
            Title = "Join Team",
            Description = "Pirate Or Marines",
            Callback = function()
                nGU:Dialog({
                    Title = "Join Team",
                    Content = "Pirate Or Marines",
                    Buttons = {
                        {
                            Title = "Pirates",
                            Callback = function()
...
ImageButton.Image = "https://www.roblox.com/asset/?id=11743199243"
