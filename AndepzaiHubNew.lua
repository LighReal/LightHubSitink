...
ImageButton.Image = "http://www.roblox.com/asset/?id=8808550143"
...
local function playSound()
	...
	sound.SoundId = "rbxassetid://8808550143"
	sound.Volume = 10
	sound:Play()
end
...
setfpscap(60)
--//macdinh
local Light = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
...
Tabs.infor:AddButton({
	Title = "Discord  | Light Hub Hub",
	Description = "Copy Link Discord",
	Callback = function()
		setclipboard("https://discord.gg/Z4BXxMyX")
	end
})
---------------TabStatus
...
local function updateMirageStatus()
	...
	if mirageIsland then
		DaoNaoCac:SetDesc('Status: Co Dao Nha')
	else
		DaoNaoCac:SetDesc('Status: Khong Co Dao')
	end
end
...
local SelectFastAttackMode = (SelectFastAttackMode or "Light Fast")
...
local function ChangeModeFastAttack(SelectFastAttackMode)
	...
	elseif SelectFastAttackMode == "Fast Attack" then
		FireCooldown = 0.07
	elseif SelectFastAttackMode == "Light Sieu Fast" then
		FireCooldown = 0.02
	end
end
...
spawn(function()
	spawn(function()
		while wait(.1) do
			if CacaoBring and _G.BringMonster and LightDepZai3 then
				pcall(function()
					for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(function()
	task.spawn(function() 
		while wait() do
			if ConCac and _G.BringMonster and LightDepZai3 then 
				pcall(function() 
					for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(function()
	task.spawn(function() 
		while wait() do
			if Ditme and _G.BringMonster and LightDepZai2 then 
				pcall(function() 
					for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(function()
	while wait() do
		if  _G.Khi_Dot_Len_Dien and LightDepZai1 then
			pcall(function()
...
Toggle:OnChanged(function(KiemNhuLon)
	NgayXuaNgayXuaCoNguoiTenLaLightDepTraiDaTaiDepTraNoiTiengTiktokNoiYoutubeCungNoiHayKiemMotNguoiDangCapHonAnDepZaiDiNheCacBanHuhuHu = KiemNhuLon
end)      

spawn(function()
	while wait() do
		if NgayXuaNgayXuaCoNguoiTenLaLightDepTraiDaTaiDepTraNoiTiengTiktokNoiYoutubeCungNoiHayKiemMotNguoiDangCapHonAnDepZaiDiNheCacBanHuhuHu then
			pcall(function()
				local args = {
				...
				if game.Players.LocalPlayer.Backpack:FindFirstChild("God's Chalice") or game.Players.LocalPlayer.Character:FindFirstChild("God's Chalice") then
					if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SweetChaliceNpc"), "Where") then
						game.StarterGui:SetCore("SendNotification", {
							...
							Icon = "http://www.roblox.com/asset/?id=12542412",
							Duration = 2.5
						})
					else
...
local ToggleTeleport = Tabs.C:AddToggle("ToggleTeleport", {
	...
	Description = "Bi Ng Ta Kill La Be De",
	Default = false
})
...
Tabs.an:AddButton({
	...
	Description = " Khong Biet Dung Dc Khong ",
	Callback = function()
		HopLowServer()
	end
})
	...
	["embeds"] = {
		{
			...
			["url"] = "https://www.roblox.com/vi/users/4270423894/profile .. game.Players.LocalPlayer.UserId,
