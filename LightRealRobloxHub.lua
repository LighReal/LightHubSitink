...
shared.LoaderTitle = "Đăng Ký Kênh Light Real Roblox";
...
local v8 = CreateObject("TextLabel", {
    ...
    Parent = v6,
    BackgroundTransparency = 1,
    Text = "Youtube: Light Real Roblox",
...
local v15 = v14:CreateWindow({
    Title = "LightReal Hub-BloxFruits",
    SubTitle = "By Light Real",
    TabWidth = 160,
    Theme = "Light",
    Acrylic = false,
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=6226848509";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/wnFNuPK7");
    end
});
